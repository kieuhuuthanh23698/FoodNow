                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button class="btn btn-primary float-right toastrDefaultSuccess" data-dismiss="modal" onclick="save_ThemDMHN()">Lưu</button>
                        </div>
...
<script type="text/javascript">
    ...
    function check(idCuaHang){
     ...
     function checkTT_CoBan_ThemDMHN(){
    var result = true;
    if($.trim($("#thongtin_chinh").val()) == ""){
      result = false;
      toastr.error("Bạn chưa điền thông tin !");
    }
    if($.trim($("#thongtin_phu").val()) == ""){
      result = false;
      toastr.error("Bạn chưa điền thông tin !");
    }
  ...
  function save_ThemDMHN(){
    if(checkTT_CoBan_ThemDMHN()){
      themSanPham();
    }
}
</script>