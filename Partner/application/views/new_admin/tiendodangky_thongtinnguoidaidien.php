    ...
    <div class="card">
        ...
        <div class="card-body">
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                  ...
                                  <div class="form-group col-sm-6">
                                            <label for="exampleInputEmail1">Họ tên đầy đủ người đại diện</label>
        ...
        <div class="card-footer">
            ...
            <div class="justify-content-between">
                    <a href="<?php echo base_url();?>Quanly_danhmuc/homeDanhmuc_dangkycuahang_TTCTCH"><button type="button" class="btn btn-primary float-right">Lưu</button></a>
            </div>
            <div class="justify-content-between">
