...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url();?>admin/HomeAdmin" class="nav-link">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge badge-warning navbar-badge" style="font-size: 15px;" id="numberOders"></span>
        </a>
        <!-- <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <!-- <div class="image"> -->
          <img id="imageUser" src="<?php echo isset($Hinh_Anh_Cua_Hang) ? api_url("public/images/").$Hinh_Anh_Cua_Hang : base_url()."dist/img/admintratorIcon.png";?>" style="width: 35px; height: 35px;" class="crop-center" alt="User Image">
        <!-- </div> -->
        </a>
