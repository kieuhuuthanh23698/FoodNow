    ...
    <div class="container-fluid" id="quickForm">
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <button type="button" class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg">Thêm
                    chi nhánh</button>

                <button type="button" class="btn btn-warning" data-toggle="modal"
                    data-target=".bd-example-modal-lg">Thêm cửa hàng</button>
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="exampleInputEmail1"
                                                aria-describedby="emailHelp" placeholder="KM001" disabled="true">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                                    <label class="control-label" for="datepicker-start">Start
                                                        Date</label>
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="inputGroupFile02" id="Chonfile">Chọn
                                                hình ảnh</label>
                                        </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header card-primary-chinhanh">
                        ...
                        <div class="card-tools">
                            <button type="button" class="btn btn-tool card-primary-chinhanh"
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="example1"
                                                    ...
                                                    aria-label="Rendering engine: activate to sort column descending">Mã
                                                    chi nhánh</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending">Hình ảnh
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending">Số cửa
                                                    hàng</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending">Chi tiết
                                                </th>
                                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="badge badge-success giatien">Hủ Tiếu Nam Vang Thành
                                                        Đạt</span></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="sparkbar" data-color="#00a65a" data-height="20">
                                                        <a href="#"><i class="nav-icon fas fa-edit" data-toggle="modal"
                                                        ...
                                                        <a href="#"><i class="far fa-trash-alt" data-toggle="modal"
                                                                data-target=".bd-example-modal-sm"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-inline">
                                                        <li class="list-inline-item">
                                                            <img alt="BunBoHue" class="img_chinhanh"
                                                                src="<?php echo base_url();?>dist/img/comchien.png">
                                                        </li>
                                                    </ul>
                                                </td>
                                                <td><a href="#">4 địa điểm</a></td>
                                    ...
                                    <table id="example3" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="example1"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Mã chi nhánh: activate to sort column descending"
                                                    aria-sort="ascending">Hình ảnh</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Tên chi nhánh: activate to sort column ascending">Tên
                                                    món</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Hình ảnh: activate to sort column ascending">Giá</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Chi tiết: activate to sort column ascending">Chi tiết
                                                </th>
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td tabindex="0" class="sorting_1"><a href="#">Cơm chiên dương châu</a>
                                                </td>
